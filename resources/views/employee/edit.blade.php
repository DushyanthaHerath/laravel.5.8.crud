...
<div class="col-md-6 offset-3">
    ...
    <form action="{{ route('employees.store') }}" method="POST" enctype="form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{ $employee->first_name }}" name="first_name" id="first_name">
        </div>
        <div class="form-group">
            <label>Last Name</label>
            <input type="text" class="form-control" value="{{ $employee->last_name }}" name="last_name" id="last_name">
        </div>
        <div class="form-group">
